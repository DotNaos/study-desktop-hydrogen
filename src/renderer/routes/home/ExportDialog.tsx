...
function GoodnotesIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="90 250 100 100" fill="none" {...props}>
            <path
                fill="#48BEDB"
                d="M145.93,266.9H99.24c-2.7,0-3.4,0.7-3.4,3.4s0.7,3.4,3.4,3.4h46.69c2.7,0,3.4-0.7,3.4-3.4S148.63,266.9,145.93,266.9z"
            />
            <path
                fill="#48BEDB"
                d="M142.18,325.95c-1.18,1.08-7.43,6.38-15.37,4.92c-5.08-0.92-8.26-4.16-9.31-5.21c-5.08-5.18-5.59-11.69-5.59-14.23c0-1.52-0.98-2.86-2.45-3.3c-1.46-0.41-3.02,0.19-3.84,1.46c-1.27,2.06-2.89,3.78-4.8,5.15c-1.05,0.76-2.19,1.4-3.4,1.91c-2.48,1.08-2.86,2-1.78,4.48c1.05,2.48,2,2.86,4.48,1.78c1.65-0.7,3.24-1.59,4.7-2.64c0.48-0.35,0.95-0.7,1.4-1.08c1.02,3.56,2.89,7.59,6.45,11.21c1.43,1.43,5.72,5.84,12.93,7.15c1.37,0.25,2.67,0.35,3.97,0.35c9.15,0,15.85-5.69,17.25-6.96c2-1.81,2.03-2.83,0.22-4.8s-2.83-2.03-4.8-0.22L142.18,325.95z"
            />
            <path
                fill="#48BEDB"
                d="M137.35,290.47H99.24c-2.7,0-3.4,0.7-3.4,3.4c0,2.7,0.7,3.4,3.4,3.4h28.62h9.5c2.7,0,3.4-0.7,3.4-3.4C140.75,291.17,140.05,290.47,137.35,290.47z"
            />
            <path
                fill="currentColor"
                fillRule="evenodd"
